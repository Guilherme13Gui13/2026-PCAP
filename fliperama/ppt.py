...
# Data       :2026.08.11
# Conceitos  :Jogo com módulo, lista como tabelas de nomes, função com retorno, operador % para dar a volta.
...
# importa as funções do título e linha do arquivo telas.py
from telas import titulo, linha

# importa a função ler_opcao que valida a entrada do usuário do arquivo modulos.py
from modulos import ler_opcao

# lista com PEDRA == posição 0, PAPEL == posição 1 e TESOURA == posição 2
